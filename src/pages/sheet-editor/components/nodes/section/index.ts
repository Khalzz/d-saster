...
export const sectionNode: Record<string, NodeTypeConfig> = {
  section: {
    ...
    label: "Section",
    allowedChildren: ["container", "section", "tabs", "image", "text-input", "level-count", "counter", "static-counter", "class-selector", "grid", "stat", "auto-stats", "auto-skills", "specie", "features-and-traits"],
